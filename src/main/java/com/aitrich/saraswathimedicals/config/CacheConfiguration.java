package com.aitrich.saraswathimedicals.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.aitrich.saraswathimedicals.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.aitrich.saraswathimedicals.repository.UserRepository.USERS_BY_EMAIL_CACHE);
