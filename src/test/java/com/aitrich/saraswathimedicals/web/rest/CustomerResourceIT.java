...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).contact(DEFAULT_CONTACT).date(DEFAULT_DATE);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().name(UPDATED_NAME).address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).date(UPDATED_DATE);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getDate()).isEqualTo(DEFAULT_DATE);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.name(UPDATED_NAME).address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).date(UPDATED_DATE);
        ...
        assertThat(testCustomer.getDate()).isEqualTo(UPDATED_DATE);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).date(UPDATED_DATE);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.name(UPDATED_NAME).address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).date(UPDATED_DATE);
